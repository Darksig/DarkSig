...
static const int64_t nTargetTimespan = 60 * 60;  // DarkSig - every 1 hour
unsigned int nTargetSpacing = 1 * 60; // DarkSig - 1 minute
static const int64_t nInterval = nTargetTimespan / nTargetSpacing;

static const int64_t nDiffChangeTarget = 1;

unsigned int nStakeMinAge = 8 * 60 * 60; // DarkSig - 8 hours
unsigned int nStakeMaxAge = -1; // DarkSig - unlimited
unsigned int nModifierInterval = 10 * 60; // DarkSig - time to elapse before new modifier is computed
...
const string strMessageMagic = "DarkSig Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DarkSig", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "blockchain.info block#489391";
        CTransaction txNew;
        txNew.nTime = 1415387020;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1415387020;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 760146 : 760146;
        ...
        assert(block.hashMerkleRoot == uint256("0x8fe026cc27d363a41fb7ad66a5e5f04572a34f7fd8db6d5e35cd9205303bf620"));
